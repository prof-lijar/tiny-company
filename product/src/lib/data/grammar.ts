...
export const grammarData: GrammarPattern[] = [
  {
    ...
    tags: ['Contrast', 'Intermediate Grammar'],
  },
  {
    id: 'g2',
    level: 3,
    ...
    examples: [
      { korean: '그녀는 한국어를 잘하면 물론 아니라 영어도 잘해요.', english: 'She not only speaks Korean well but also English.' },
      { korean: '이 식당은 음식 맛이 좋은 물론 아니라 서비스도 친절해요.', english: 'This restaurant not only has great food but also friendly service.' },
    ],
    usage_notes: 'Commonly used to add more information that is in the same direction (positive or negative).',
    tags: ['Addition', 'Intermediate Grammar'],
  },
  {
    id: 'g3',
    level: 4,
    title: '-기 때문에',
    pattern: '-기 때문에',
    explanation: 'Used to express a reason or cause. More formal than -아서/어서.',
    examples: [
  ...
  },
  {
    ...
    tags: ['Inference', 'Observational Grammar'],
  },
  {
    id: 'g5',
    level: 5,
    title: '-거니와',
    pattern: '-거니와',
    explanation: 'Used to express that the first clause is a given fact and adds another fact to it. Similar to -ㄴ뿐만 아니라 but more formal/literary.',
    examples: [
      { korean: '그는 성격이 좋은 거니와 능력도 뛰어납니다.', english: 'He not only has a good personality but also possesses outstanding ability.' },
      { korean: '이 지역은 경치가 아름다운 거니와 공기도 맑습니다.', english: 'This region has beautiful scenery and the air is also clean.' },
    ],
    usage_notes: 'Often used in written language or formal speeches.',
    tags: ['Addition', 'Advanced Grammar', 'Formal'],
  },
  {
    id: 'g6',
    level: 5,
    ...
    tags: ['General Truth', 'Advanced Grammar'],
  },
  {
    id: 'g7',
    level: 6,
    ...
    examples: [
      { korean: '방심하면 실수하기 쉽다.', english: 'Mistakes are easy to make if you let your guard down.' },
      { korean: '과도한 기대는 실망하기 쉽다.', english: 'Excessive expectations often lead to disappointment.' },
    ],
    usage_notes: 'Usually used with negative outcomes.',
    tags: ['Tendency', 'Advanced Grammar'],
  },
  {
    id: 'g8',
    level: 6,
    ...
    tags: ['Strong Denial', 'Advanced Grammar'],
  },
];
