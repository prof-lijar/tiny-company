...
export const READING_PASSAGES: ReadingPassage[] = [
  {
    ...
    content: `한국 사람들은 예전부터 김치를 많이 먹었습니다. 김치는 배추나 무 같은 채소를 소금에 절여서 고춧가루, 마늘, 젓갈 등을 넣어 만든 음식입니다. 김치에는 비타민과 무기질이 많아서 건강에 매우 좋습니다. 요즘은 외국 사람들도 김치의 맛과 건강 효능에 관심을 가지고 많이 먹기 시작했습니다. 특히 매운 맛을 좋아하는 사람들이 김치를 선호합니다.`,
    questions: [
      {
        id: 'q1-1',
        question: '이 글의 주제로 가장 알맞은 것은 무엇입니까?',
        options: [
          '김치를 만드는 방법',
          '김치의 특징과 장점',
          '한국의 다양한 채소',
      ...
      },
      {
        ...
        correctAnswer: 2,
        explanation: 'The text explicitly states "김치에는 비타민과 무기질이 많아서 건강에 매우 좋습니다" (Kimchi is very good for health because it has many vitamins and minerals).'
      }
    ]
  },
  {
    ...
    content: `현대 사회에서는 스마트폰의 보급으로 인해 언제 어디서나 빠르게 소통할 수 있게 되었습니다. 하지만 역설적이게도 사람들은 과거보다 더 외로움을 느낀다고 합니다. 온라인상의 관계는 넓지만 깊이가 부족하기 때문입니다. 진정한 소통은 단순히 정보를 주고받는 것이 아니라 서로의 감정을 공유하고 공감하는 과정입니다. 따라서 우리는 디지털 기기에서 벗어나 직접 얼굴을 마주 보는 시간을 늘려야 합니다.`,
    questions: [
      {
        id: 'q2-1',
    ...
    questions: [
      {
        ...
        options: [
          '인간보다 더 뛰어난 예술적 능력을 갖췄다고 본다.',
          '데이터 학습을 통해 진정한 예술을 구현했다고 본다.',
          '인간의 고유한 의지와 철학이 결여되었다고 본다.',
          '결과물의 완성도가 높으므로 예술로 인정해야 한다고 본다.'
        ],
        correctAnswer: 2,
