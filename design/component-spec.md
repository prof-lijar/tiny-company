...
- **Structure:**
    ...
    - **Body:** The summarized narrative text.
...
If TraceWhisper moves to a web dashboard, the following components should be carried over:
...
- **The Evidence Link:** A hyperlinked narrative segment that scrolls the log pane to the exact line.
