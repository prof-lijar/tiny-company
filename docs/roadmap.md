...
**Goal**: Establish the core study loop and provide immediate value through high-quality practice materials.

- [x] **Landing Page**: High-conversion page with value prop and pricing.
- [x] **Vocabulary Builder**: Implementation of SRS flashcards for Levels 3-6.
- [x] **Grammar Library**: Level-organized lessons with examples and usage notes.
- [x] **Reading Practice**: TOPIK-style passages with multiple-choice questions and explanations.
- [x] **Korean Typography**: Integration of Noto Sans KR.
- [x] **Responsive Layout**: Desktop-first study interface.
...
- [x] **Listening Module**: Audio-integrated practice and mock test sections.
