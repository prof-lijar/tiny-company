...
- **Logs, Traces, and System Prompts:** To provide the Service's core functionality (synthesis, narratives, and the "Fix-It" engine), TraceWhisper processes the logs, execution traces, and the system prompts of your AI agents. 
